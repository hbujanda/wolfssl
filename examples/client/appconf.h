 ...
 * @since 1.0
*ad*/
#define APP_ROOT_STACK_SIZE     (128*1024)
 ...
 * @since 1.0
*ad*/
#define APP_DIALOG_APP_NAME         "WolfSSL Client Example Application"
 ...
 * @since 5.0
*ad*/
#define APP_SNTP_PRIMARY            "129.6.15.28"
 ...
 * @since 5.0
*ad*/
#define APP_SNTP_SECONDARY          "129.6.15.29"
 ...
 *  <item>Set APP_WLN_80211_BAND to APP_WLN_80211_BAND_BGN to enable support for
 *        the 802.11b/g/n bands.</item>
 ...
 *        9215 platforms, and 802.11b/g/n bands on Digi Connect WIME 9210 platform.</item>
 * </list>
 *          
...
/*ad*
 * APP_IPV6_GATEWAY will be used as the default static IPv6 gateway, if APP_USE_NVRAM 
 * is set to 0 (or if NVRAM has not been initialized) and @link APP_USE_STATIC_IPV6 
 * is enabled for the interface.
 *
 * This value should be specified as a properly formatted IPv6 address string.  
...
/*ad*
 * APP_2ND_INTERFACE_IPV6_GATEWAY will be used as the default static IPv6 address for
 * the 2nd netword interface (on the system with 2 network interfaces), if APP_USE_NVRAM 
 * is set to 0, or if NVRAM has not been initialized and @link APP_USE_STATIC_IPV6 
 * is enabled for the interface.
 *
 ...
 * @since 7.5
*ad*/
#define	APP_2ND_INTERFACE_IPV6_GATEWAY		"::"
...
#define APP_BUILD_COMPRESSED_IMAGE  1
