...
WOLF_STACK_OF(WOLFSSL_X509)* wolfSSL_sk_X509_new_null(void)
{
    WOLF_STACK_OF(WOLFSSL_X509)* newX509;

    newX509 = (WOLF_STACK_OF(WOLFSSL_X509)*)XMALLOC(sizeof(WOLF_STACK_OF(WOLFSSL_X509)), NULL, DYNAMIC_TYPE_X509);
    if (newX509 != NULL) {
        newX509->num = 0;
...
/*** TBD ***/
WOLFSSL_API WOLF_STACK_OF(SSL_COMP) *wolfSSL_COMP_get_compression_methods(void)
{
